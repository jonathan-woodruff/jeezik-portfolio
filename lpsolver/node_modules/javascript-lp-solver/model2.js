...
const variables = {};
const ints = {};
variables["w"] = { "max hours": 1 };
variables["y"] = { "min hours": 1 };
for (let g = 0; g < days.length; g++) {
    key = "u[" + g.toString() + "]";
    variables[key] = { "daily max hours": 1 };
    key = "v[" + g.toString() + "]";
    variables[key] = { "daily min hours": 1 };
...
var solver = require("./src/solver"),
  results,
  model = {
    //"optimize": { "travel time": "min", "daily max hours": "min" },//"travel time",
    "optimize": "max hours",
    "opType": "min",
