exports.generateOptimalPaths = (selectedDoctors) => {
    ...
    const nodes = {
        "Monday": {
            "0": {
                location: "dummy source",
                interval: "dummy source"
            },
            "1": {
            ...
            "5": {
                location: "dummy destination",
                interval: "dummy destination"
            }
        },
        "Tuesday": {
            "0": {
    ...
    const dummyDestinationNodes = ["5", "9", "10"]; //dummy destination node at day 0 is 5
    ...
    */
    ...
    return {
        ...
        doctors: doctors,
        nodes: nodes,
        dummyDestinationNodes: dummyDestinationNodes
    };
};